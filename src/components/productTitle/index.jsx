...
export default function ProductTitle({singleProductTitle}){
    ...
    return (
        <div className="relative group border border-cyan-700 cursor-pointer p-7 rounded-xl shadow-xl">
            ...
            <div className="flex items-start justify-between mt-4 space-x-5">
            ...
            }} className="!px-5 !mt-5 !w-full !py-2 !rounded-none !bg-black text-white !font-bold !text-lg">View details</button>
            <button disabled={
            ...
            className="disabled:opacity-20 !px-5 !mt-5 !w-full !py-2 !rounded-none !bg-black text-white !font-bold !text-lg">Add to cart</button>
        </div>
    )
}